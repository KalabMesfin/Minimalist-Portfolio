...
const Approach = () => {
  return (
    <>
      <div className="p
        my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
        <Card 
        ...
        <Card 
          ...
          icon={<AceternityIcon order="Phases 2" />}
...
const Card = ({
  ...
  return (
    <div
      ...
      className="border border-black/[0.2] group/canvas-card flex items-center justify-center dark:border-white/[0.2]  max-w-sm w-full mx-auto p-4 lg:h-[35rem]"
    >
